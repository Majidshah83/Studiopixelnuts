...
<form action="{{route('delete-package',$customid->id)}}" method="post">
    @csrf
  ...
  <div class="formSection">
    ...
    <div class="row mt-3">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-2">
        <label for="nameIncorporatedLogo" class="formLabel">Product Name:
        </label>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="sloganIncorporatedLogo" class="formLabel">A short description of the product:</label>:
        </label>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="descLogo" class="formLabel">Which type of packaging do you need:
        </label>
        <!-- <input type="text" class="input" maxlength="800" name="descLogo"> -->
        <div class="displayInputData">
             {{$customid->typeOfPackage}}

                    </div>
      </div>
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="visionFlogo" class="formLabel">Packaging logo design and attached designs:
        </label>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="logoColor" class="formLabel"> Size of your packaging:<br>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="logoFont" class="formLabel">Attach references to the designs:<br>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="logoFont" class="formLabel">Attach Logo designs:<br>
          <!-- <i>(Optional: Attach images of fonts that you like)
          </i> -->
        </label>
        <div class="displayInputData">
     ...
     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="logoFont" class="formLabel">Text to be used in packaging design:<br>
          <!-- <i>(Optional: Attach images of fonts that you like)
          </i> -->
        </label>
        <div class="displayInputData">
   ...
   <!--6th-->
   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="logoFont" class="formLabel">Attach Images:<br>
          <!-- <i>(Optional: Attach images of fonts that you like)
          </i> -->
        </label>
        <div class="displayInputData">
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="logoFont" class="formLabel">Colors Package Design:<br>
          <!-- <i>(Optional: Attach images of fonts that you like)
          </i> -->
        </label>
        <div class="displayInputData">
...
<!--8TH-->
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="logoFont" class="formLabel">Fonts Package Design:<br>
          <!-- <i>(Optional: Attach images of fonts that you like)
          </i> -->
        </label>
        <div class="displayInputData">
     ...
     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="includeWebsite" class="formLabel">Website and social media pages:</label>
        <!-- <input type="text" name="Country" class="input" maxlength="800"> -->
        <div class="displayInputData">
...
<!--9th-->
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="logoFont" class="formLabel">Barcode Package Design:<br>
          <!-- <i>(Optional: Attach images of fonts that you like)
          </i> -->
        </label>
        <div class="displayInputData">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="manufactured" class="formLabel">Product Manufactured:</label>
        <!-- <input type="text" name="Country" class="input" maxlength="800"> -->
        <div class="displayInputData">
             {{$customid->productManufacture}}
                    </div>
      </div>
<!--10TH-->
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <p class="formLabel mb-2">
         ...
         <div class="checkboxDiv">
          ...
          <div class="checkBoxCol">
            <div class="Checkbox">
              <div class="cntr">
                <input type="checkbox" id="test" class="hidden-xs-up cbx1" name="classic" {{  ($customid->classic == 'on' ? ' checked' : '') }}>
            ...
            <div class="Checkbox">
              <div class="cntr">
                <input type="checkbox" id="test" class="hidden-xs-up cbx1" name="mature"  {{  ($customid->mature == 'on' ? ' checked' : '') }}>
