  ...
  <div class="formSection">
    ...
    <div class="row mt-3">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <input type="text" name="photos" class="input required-inputs" maxlength="800">
        <label for="photosfile" class="inpimg required-inputs required"><i class="fas fa-image"></i></label> <input type="file" id="photosfile" name="photos_file[]" class="inpFile required-inputs" multiple>
      </div>
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <input type="text" name="images" class="input  required-inputs" maxlength="800">
      </div>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <input type="text" name="timage" class="input  required-inputs" maxlength="800">
      </div>
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="tgAudienece" class="formLabel">If you’d like to use any stock photos in this image, provide links:
        </label>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <input type="text" name="text_image" class="input required-inputs" maxlength="800">
      </div>
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="tgAudienece" class="formLabel">If you’d like to use any stock photos in this image, provide links:
        </label>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <input type="text" name="audi_image" class="input  required-inputs" maxlength="800">
      </div>
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="tgAudienece" class="formLabel">If you’d like to use any stock photos in this image, provide links:
        </label>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <input type="text" name="image_tg" class="input required-inputs" maxlength="800">
      </div>
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        <label for="tgAudienece" class="formLabel">If you’d like to use any stock photos in this image, provide links:
        </label>
...
<div class="row mt-4">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <label for="barcodeimg" class="inpimg"><i class="fas fa-image"></i></label> <input type="file" name="palette_file[]" id="barcodeimg" class="inpFile" multiple>
      </div>
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <input type="text" name="target_image" class="input required-inputs" maxlength="800">
      </div>
