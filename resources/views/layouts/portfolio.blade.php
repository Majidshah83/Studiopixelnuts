        ...
        <div id="myModal" class="modal">
          ...
          <div class="modal-content">
            ...
            <div class="mySlides">
              ...
              <img src="{{asset('public/img/gallery/logo_1.jpg')}}" style="width:100%">
            </div>

            <div class="mySlides">
              <div class="numbertext">2 / 4</div>
              <img src="{{asset('public/img/gallery/logo_2.jpg')}}" style="width:100%">
            </div>

            <div class="mySlides">
              <div class="numbertext">3 / 4</div>
              <img src="{{asset('public/img/gallery/logo_3.jpg')}}" style="width:100%">
            </div>
            <div class="mySlides">
              <div class="numbertext">3 / 4</div>
              <img src="{{asset('public/img/gallery/logo_4.jpg')}}" style="width:100%">
            </div>
            <div class="mySlides">
              <div class="numbertext">3 / 4</div>
              <img src="{{asset('public/img/gallery/logo_5.jpg')}}" style="width:100%">
            </div>

            <div class="mySlides">
              <div class="numbertext">4 / 4</div>
              <img src="{{asset('public/img/gallery/logo_6.jpg')}}">
            </div>
    ...
    <div class="container">
      <div class="section-top-border">
        ...
        <div class="row gallery-item">
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Package_1.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Package_2.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Package_3.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Package_4.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Package_5.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Package_6.jpg')}}');"></div>
            </a>
          </div>
    ...
    <div class="container">
      <div class="section-top-border">
        ...
        <div class="row gallery-item">
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Insert_1.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Insert_2.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Insert_3.jpg')}}');"></div>
            </a>
          </div>
    ...
    <div class="container">
      <div class="section-top-border">
        ...
        <div class="row gallery-item">
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image ll" style="background: url('{{asset('public/img/gallery/EBC_1.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6">
            <a>
              <div class="single-gallery-image ll" style="background: url('{{asset('public/img/gallery/EBC_2.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image ll" style="background: url('{{asset('public/img/gallery/EBC_3.jpg')}}');"></div>
            </a>
          </div>
    ...
    <div class="container">
      <div class="section-top-border">
        ...
        <div class="row gallery-item">
          ...
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Hero_1.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Hero_2.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Hero_3.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Hero_4.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Hero_5.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Hero_6.jpg')}}');"></div>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="section-top-border">
        ...
        <div class="row gallery-item">
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/WB_1.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/WB_2.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/WB_3.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/WB_4.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/WB_5.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/WB_6.jpg')}}');"></div>
            </a>
          </div>
    ...
    <div class="container" style="margin-bottom: 70px;">
      <div class="section-top-border">
        ...
        <div class="row gallery-item">
          ...
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Lifestyle_1.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Lifestyle_2.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Lifestyle_3.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Lifestyle_4.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Lifestyle_5.jpg')}}');"></div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mx-auto">
            <a>
              <div class="single-gallery-image" style="background: url('{{asset('public/img/gallery/Lifestyle_6.jpg')}}');"></div>
            </a>
          </div>
