  ...
  <form id="myForm" method="POST" action="{{ url('formstore') }}" enctype="multipart/form-data">
    ...
    <div class="row mt-0">
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-3">
        ...
        <input type="number" class="input required-inputs" maxlength="800" name="zipcode" required>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-3">
    ...
    <div class="row mt-3">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
        ...
        <label for="attachlogodesign" class="inpimg required"><i class="fas fa-image"></i></label> <input type="file" id="attachlogodesign" name="visionFlogo[]" class="inpFile required-inputs" multiple>
      </div>
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
